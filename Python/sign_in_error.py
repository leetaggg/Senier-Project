...
class Ui_sign_in_error(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("관리자 로그인 실패")
        ...
        self.Error_str.setGeometry(QtCore.QRect(60, 30, 310, 30))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowFlag(QtCore.Qt.WindowCloseButtonHint, False)
        Dialog.setWindowTitle(_translate("Dialog", "관리자 모드 로그인 실패"))
        self.OK.setText(_translate("Dialog", "돌아가기"))
        self.Error_str.setText(_translate("Dialog", "관리자 계정이 아니거나 아이디와 비밀번호가 틀립니다."))
